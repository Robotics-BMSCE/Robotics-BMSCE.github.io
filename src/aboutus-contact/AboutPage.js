...
const aboutDescription = "You would be lying if you said that you didn't find Sophia the humanoid cool to say at the very least. Did you know that she's a citizen of Saudi Arabia??\n\nWant to know the what, why and how of robotics?\nWant to explore the vast field of robotics, meet awesome people and build the coolest bots?\nWhy then, the BMSCE Robotics Club is the right place!\nWe are a student body which takes interest in various competitions year while long. Check out more about our competitions on the Events page! Dive deep into the learning process and participate in nation wide competitions, all while growing with your peers. We strongly believe in teamwork, dedication, and of course, learning! So, get ready to join this amazing and talented team to hone your skills and get sucked into the exciting and ever-expanding world of robotics."
